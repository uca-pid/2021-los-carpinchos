...
class TestUser(APITestCase):
    ...
    def test_user_creation_with_no_name_fail(self):
    ...
    def test_user_creation_with_no_email_fail(self):
        user = mb_user(name='sofia', email='',
                       manager='Toto', password='Pass')
        with self.assertRaises(ValidationError):
            user.full_clean()
            user.save()
    def test_user_creation_with_no_pass_fail(self):
        user = mb_user(name='sofia', email='h@gmail.com',
                       manager='Toto', password='')
        with self.assertRaises(ValidationError):
            user.full_clean()
            user.save()

    def test_user_creation_with_no_manager_fail(self):
        user = mb_user(name='sofia', email='h@gmail.com',
